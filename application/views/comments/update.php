...
<?php echo form_open('comments/update/'.$id); ?>
    <div id="form-new-comment" class="col-md-8 offset-md-2">
        ...
        <div class="col-md-2 offset-md-5"> 
           <input class="btn btn-primary" type="submit" name="submit" value="Modifier un commentaire" />
        </div>
    </div>
</form>